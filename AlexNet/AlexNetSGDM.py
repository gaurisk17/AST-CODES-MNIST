...
# Training loop
print("Training AlexNet with SGD-Momentum optimizer")
...
plt.plot(train_loss_list, label='SGD-Momentum')
plt.xlabel("Epochs")
plt.ylabel("Training Loss")
plt.title("MNIST Training Loss with AlexNet (SGD-Momentum)")
...
# Plot accuracy
plt.figure(figsize=(10, 6))
plt.plot(accuracy_list, label='SGD-Momentum')
plt.xlabel("Epochs")
plt.ylabel("Accuracy (%)")
plt.title("MNIST Training Accuracy with AlexNet (SGD-Momentum)")
