...
# Training loop
print("Training with Vanilla SGD optimizer")
...
plt.title("MNIST Training Loss with Vanilla SGD Optimizer")
...
plt.xlabel("Epochs")
plt.ylabel("Accuracy (%)")
plt.title("MNIST Training Accuracy with Vanilla SGD Optimizer")
