...
from torch.optim import NAdam  # Importing NAdam optimizer
...
batch_size = 128
num_epochs = 50
learning_rate = 0.002  # Slightly higher learning rate for Nadam
...
# Training loop
print("Training AlexNet with Nadam optimizer")
...
plt.title("MNIST Training Loss with AlexNet (Nadam)")
...
plt.xlabel("Epochs")
plt.ylabel("Accuracy (%)")
plt.title("MNIST Training Accuracy with AlexNet (Nadam)")
