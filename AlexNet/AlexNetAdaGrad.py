...
# Training loop
print("Training AlexNet with AdaGrad optimizer")
...
plt.title("MNIST Training Loss with AlexNet (AdaGrad)")
...
plt.xlabel("Epochs")
plt.ylabel("Accuracy (%)")
plt.title("MNIST Training Accuracy with AlexNet (AdaGrad)")
