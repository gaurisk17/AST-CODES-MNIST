...
# Training loop
print("Training AlexNet with AdaDelta optimizer")
...
plt.title("MNIST Training Loss with AlexNet (AdaDelta)")
...
plt.xlabel("Epochs")
plt.ylabel("Accuracy (%)")
plt.title("MNIST Training Accuracy with AlexNet (AdaDelta)")
