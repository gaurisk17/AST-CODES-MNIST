...
batch_size = 128
num_epochs = 50
learning_rate = 0.001  # Standard learning rate for Adam-based optimizers
...
# AMSGrad optimizer (Adam with amsgrad=True)
...
# Training loop
print("Training AlexNet with AMSGrad optimizer")
...
plt.title("MNIST Training Loss with AlexNet (AMSGrad)")
...
plt.xlabel("Epochs")
plt.ylabel("Accuracy (%)")
plt.title("MNIST Training Accuracy with AlexNet (AMSGrad)")
